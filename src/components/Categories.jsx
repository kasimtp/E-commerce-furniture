  ...
  return (
    <div className="w-full h-full flex flex-col sm:space-y-14 font-Poppins space-y-4 bg-white">
      ...
      <div className="bg-amber-200 flex flex-row space-x-3 border rounded-2xl">
        ...
        <div className=" w-20 h-20 sm:w-12 sm:h-12 object-contain bg-gradient-to-br from-yellow-300 to-orange-400 rounded-full p-2 border-4 border-white shadow-md hover:scale-105 transition-transform duration-300  items-center justify-center">
