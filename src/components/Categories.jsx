    ...
    <div className="w-full py-10 bg-white font-Poppins flex flex-col items-center space-y-8">
      ...
      <div className="flex overflow-x-auto space-x-5 px-4 py-4 scrollbar-hide w-full max-w-5xl">
        {categoryIcons.map((category, index) => (
          <div
            key={index}
            className="w-24 aspect-square bg-gradient-to-br from-yellow-300 to-orange-400 rounded-full p-3 border-4 border-white shadow-md hover:scale-105 transition-transform duration-300 flex items-center justify-center shrink-0"
          >
            <img
              src={category.img}
              alt={category.alt}
