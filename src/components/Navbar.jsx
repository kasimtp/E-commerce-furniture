  ...
  return (
    <nav className="bg-white shadow-md border-b sticky top-0 z-50 px-4 py-2">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* Center - Logo */}
        <div className="flex items-center gap-2 flex-grow md:flex-grow-0 md:ml-4">
          <img src={logo} alt="Logo" className="h-10 w-auto object-contain" />
          <div className="text-pink-600 font-bold leading-tight hidden sm:block">
            <h1 className="text-lg">Imarihba</h1>
            <p className="-mt-1 text-sm">Designer Hub</p>
          </div>
        </div>
        ...
        <div className="hidden md:flex flex-grow mx-4">
          <div className="flex w-full max-w-md rounded-md overflow-hidden border border-gray-300">
            <input
              ...
              className="w-full px-4 py-2 outline-none text-sm text-gray-600"
            />
            <button className="bg-pink-600 px-4 flex items-center justify-center text-white">
              <FiSearch size={20} />
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <Link to="/shoppingcart" className="relative text-gray-700">
            <BsCart4 size={24} className="text-purple-800" />
            {cartItems.length > 0 && (
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden mt-2 border-t border-gray-200 bg-white px-4 py-3">
          ...
          {token ? (
            ...
            <Link
              to="/register"
              className="mt-4 block w-full text-center bg-pink-600 text-white py-2 rounded-md hover:bg-pink-700"
            >
              Register / Login
            </Link>
          )}
